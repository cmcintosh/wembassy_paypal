...
/**
* The idea is to replicate the functionality available in Drupal 7
* So the initial version is documented identical to that api documentation.
*/
 ...
 */
function hook_wembassy_paypal_ipn_process($order, $payment_method, $ipn) { }
 ...
 */
function hook_wembassy_paypal_api_request_alter(&$nvp, $order, $payment_method) { }
